...
//   At: 2025-04-07T19:40:04.4408613-05:00
//
...
public partial class SensorEntities
{
    ...
    public NumericSensorEntity BlinkBasementWiFiSignalStrength => new(_haContext, "sensor.blink_basement_wi_fi_signal_strength");
    ...
    public NumericSensorEntity BlinkUpstairsWiFiSignalStrength => new(_haContext, "sensor.blink_upstairs_wi_fi_signal_strength");
    ...
    ///<summary>Office Sensor Illuminance</summary>
    public NumericSensorEntity OfficeSensorIlluminance => new(_haContext, "sensor.office_sensor_illuminance");
    ///<summary>Office Sensor Temperature</summary>
    public NumericSensorEntity OfficeSensorTemperature => new(_haContext, "sensor.office_sensor_temperature");
}
...
public partial class SwitchEntities
{
    ...
    ///<summary>Couch Side Table Lamp</summary>
    ...
    ///<summary>Front Door In-home chime</summary>
    public SwitchEntity FrontDoorInHomeChime => new(_haContext, "switch.front_door_in_home_chime");
    ///<summary>Front Door Motion detection</summary>
    public SwitchEntity FrontDoorMotionDetection => new(_haContext, "switch.front_door_motion_detection");
    ///<summary>Garage Motion detection</summary>
    public SwitchEntity GarageMotionDetection => new(_haContext, "switch.garage_motion_detection");
    ...
    ///<summary>Office Sensor Light sensor enabled</summary>
    public SwitchEntity OfficeSensorLightSensorEnabled => new(_haContext, "switch.office_sensor_light_sensor_enabled");
    ///<summary>Office Sensor Motion sensor enabled</summary>
    public SwitchEntity OfficeSensorMotionSensorEnabled => new(_haContext, "switch.office_sensor_motion_sensor_enabled");
...
public partial class CameraEntities
{
    ...
    ///<summary>Front Door Last recording</summary>
    public CameraEntity FrontDoor => new(_haContext, "camera.front_door");
    ///<summary>Front Door Live view</summary>
    public CameraEntity FrontDoorLiveView => new(_haContext, "camera.front_door_live_view");
    ///<summary>Garage Last recording</summary>
    public CameraEntity Garage => new(_haContext, "camera.garage");
    ///<summary>Garage Live view</summary>
    public CameraEntity GarageLiveView => new(_haContext, "camera.garage_live_view");
...
public partial class EventEntities
{
    ...
    ///<summary>Front Door Ding</summary>
    public EventEntity FrontDoorDing => new(_haContext, "event.front_door_ding");
    ///<summary>Front Door Motion</summary>
    public EventEntity FrontDoorMotion => new(_haContext, "event.front_door_motion");
    ///<summary>Garage Motion</summary>
    public EventEntity GarageMotion => new(_haContext, "event.garage_motion");
}
...
public partial class NumberEntities
{
    ...
    ///<summary>Front Door Volume</summary>
    public NumberEntity FrontDoorVolume => new(_haContext, "number.front_door_volume");
    ///<summary>Garage Volume</summary>
